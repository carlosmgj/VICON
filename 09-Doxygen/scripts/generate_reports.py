...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='Genera página de reportes Doxygen')
    parser.add_argument('reports_path', help='Ruta carpeta con reportes GHDL y VSG')
    parser.add_argument('--out', default='content/reports.dox',
                        help='Ruta del fichero .dox de salida')
